...
namespace assignment8ex1
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            // instantiating delagate objects
            songDelegate thisSong = new songDelegate(HereComesTheSun.chorus);
            thisSong += HereComesTheSun.verse1;
            thisSong += HereComesTheSun.chorus;
            thisSong += HereComesTheSun.verse2;
            thisSong += HereComesTheSun.chorus2;
            thisSong += HereComesTheSun.verse3;
            thisSong += HereComesTheSun.chorus;
            thisSong += HereComesTheSun.chorus;
            thisSong += HereComesTheSun.end;
            thisSong();
        }
    }
}